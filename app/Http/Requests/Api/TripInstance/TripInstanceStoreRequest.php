...
class TripInstanceStoreRequest extends FormRequest
{
    use ApiResponse;
    ...
    {
        return [
            'coach_configuration_id' => ['required', 'exists:coach_configurations,id'],
    ...
    protected function failedAuthorization(): void
    {
        throw new HttpResponseException(
            $this->forbiddenResponse('You do not have permission to create a trip instance.')
        );
    }
}
