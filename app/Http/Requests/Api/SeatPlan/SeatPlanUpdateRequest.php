...
class SeatPlanUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => ['required', 'string', 'max:255', Rule::unique('seat_plans', 'name')->where('floor', $this->input('floor'))->ignore($id)],
    ...
    protected function failedAuthorization(): void
    {
        throw new HttpResponseException(
            $this->forbiddenResponse('You do not have permission to update this seat plan.')
        );
    }
}
