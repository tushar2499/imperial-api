...
@section('content')
    <div class="container">
        <h1 class="mb-4">API: Update Trip Instance</h1>

        <h3>Request</h3>
        <p>Update the details of a specific trip instance by ID:</p>
  ...
  "data": {
    ...
    "boarding_droppings": [
      ...
      },
      {
        ...
        <h3>Notes:</h3>
        <ul>
            <li>The trip instance ID is required in the URL to specify which configuration to update.</li>
