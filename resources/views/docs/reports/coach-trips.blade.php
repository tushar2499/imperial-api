...
@section('content')
    <div class="container">
        ...
        <h3>Request</h3>
        <p>Retrieve all coach trips with a <strong>GET</strong> request:</p>
        <pre><code>GET /reports/coach-trips</code></pre>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><code>bus_id</code></td>
                        <td>Integer</td>
                        <td>Filter by specific bus</td>
                        <td>1</td>
                        <td>No</td>
                    </tr>
                    <tr>
                        ...
                        <td>Integer</td>
                        <td>Filter by specific schedule</td>
                        <td>1</td>
                        <td>No</td>
                    </tr>
                </tbody>
