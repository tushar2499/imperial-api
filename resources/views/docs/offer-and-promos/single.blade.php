...
@section('content')
    <div class="container">
        <h1 class="mb-4">API: Get Specific Offer and promo</h1>

        <h3>Request</h3>
        <p>Retrieve a specific offer and promo by ID:</p>
        <pre><code>GET /offer-and-promos/{id}</code></pre>
...
{
    "status": "success",
    "message": "Offer and promo retrieved successfully",
    "data": {
        "id": 1,
